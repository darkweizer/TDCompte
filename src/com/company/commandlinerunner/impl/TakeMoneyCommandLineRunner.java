...
public class TakeMoneyCommandLineRunner extends CommandLineRunner {
    @Override
    public void execute() {
        ...
        while(choiceAccount) {
            ...
            if(compte != null){
                choiceAccount = false;
                compte.retrait(console.printMessageAndGetConsoleNumber("Quelle montant voulez-vous retirer?"));
            } else {
